      ...
      <div className="space-y-6">
        ...
        {detailedResults.map((result, index) => {
          ...
          return (
            <div
              key={index}
              className="bg-white/80 backdrop-blur-xl p-4 border-2 border-slate-200 rounded-2xl shadow-lg shadow-slate-200/50"
            >
              <div className="flex items-start justify-between gap-4 mb-3">
                ...
                <div
                  className={`shrink-0 w-10 h-10 rounded-xl flex items-center justify-center ml-4${
                    isCorrect
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        ...
                        <div className="shrink-0 flex items-center gap-2 mt-2 sm:mt-0 self-end sm:self-auto">
                          {isCorrectOption && (
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-100 border border-emerald-300 rounded-lg text-xs font-semibold text-emerald-700 shadow-sm">
                              <CheckCircle2
                          ...
                          {isWrongAnswer && (
                            <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-rose-100 border border-rose-300 rounded-lg text-xs font-semibold text-rose-700 shadow-sm">
                              <XCircle
                                className="w-3.5 h-3.5"
                                strokeWidth={2.5}
                              />
