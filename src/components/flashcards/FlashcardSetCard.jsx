    ...
    >
      ...
      <div className="mt-6 pt-4 border-t border-slate-100">
        <button
          ...
          className="group/btn relative w-full h-1 bg-linear-to-r from-emerald-100 to-teal-100 hover:from-emerald-600 hover:to-teal-600 text-emerald-700 hover:text-white font-semibold text-sm rounded-xl transition-all duration-200 active:scale-95 overflow-hidden"
        >
